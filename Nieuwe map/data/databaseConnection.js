...
const CategorySchema = require("../api/models/categorySchema");
const QuizzerSchema = require("../api/models/quizzerSchema");
const QuestionSchema = require("../api/models/questionsSchema");
const actionsRouter = require("../api/routes/action.js");
